              ...
              <div className="container-wide py-4 px-4 space-y-2">
                {navItems.map((item) => (
                  <Link
                    ...
                    className="block py-3 px-4 rounded-xl text-foreground hover:bg-primary/10 transition-colors"
                  >
                    {t(item.key)}
                  </Link>
                ))}
                <Link
                  to="/donate"
                  onClick={() => setIsOpen(false)}
                  className="block py-3 px-4 rounded-xl gradient-primary text-primary-foreground text-center font-semibold"
                >
                  {t('nav.donate')}
                </Link>
              </div>
