...
const DonatePage: React.FC = () => {
  ...
  const programs = [
    { id: 'general', name: 'Where Most Needed', icon: Heart, color: 'bg-primary', description: 'Let us allocate your donation where it\'s needed most' },
    { id: 'education', name: 'Education', icon: GraduationCap, color: 'bg-blue-500', description: 'Support scholarships & school supplies', image: educationImage },
    { id: 'healthcare', name: 'Healthcare', icon: HeartPulse, color: 'bg-red-500', description: 'Fund medical camps & treatments', image: healthcareImage },
    { id: 'water', name: 'Clean Water', icon: Droplets, color: 'bg-cyan-500', description: 'Install wells & purification systems', image: waterImage },
    { id: 'emergency', name: 'Emergency Relief', icon: AlertTriangle, color: 'bg-orange-500', description: 'Rapid disaster response', image: emergencyImage },
  ];

  const fundUtilization = [
    { label: 'Education Programs', percentage: 27, color: 'bg-blue-500' },
    { label: 'Healthcare Services', percentage: 23, color: 'bg-red-500' },
    { label: 'Clean Water Projects', percentage: 31, color: 'bg-cyan-500' },
    { label: 'Emergency Relief', percentage: 21, color: 'bg-orange-500' },
    { label: 'Administrative', percentage: 2, color: 'bg-gray-400' },
  ];

  const impactExamples = [
    { amount: 500, impact: 'Provides school supplies for 2 children' },
    { amount: 1000, impact: 'Funds a health checkup for 5 families' },
    { amount: 2500, impact: 'Supplies clean water for a week to a village' },
    { amount: 5000, impact: 'Sponsors a child\'s education for 3 months' },
    { amount: 10000, impact: 'Funds a complete medical camp' },
    { amount: 25000, impact: 'Installs a water purification unit' },
  ];

  const finalAmount = customAmount ? parseInt(customAmount) : selectedAmount;
  const currentImpact = impactExamples.find(i => i.amount === finalAmount)?.impact || 
    (finalAmount && finalAmount > 0 ? `Makes a meaningful difference in communities` : '');
            ...
            <div className="grid lg:grid-cols-3 gap-8">
              ...
              <div className="lg:col-span-2 space-y-8">
                ...
                >
                  ...
                  {currentImpact && finalAmount && finalAmount > 0 && (
                    <motion.div 
